...
#include <android/hardware/credential/1.0/IIdentityCredentialStore.h>
...
class CredentialStoreHidlTest : public ::testing::VtsHalHidlTargetTestBase {
 public:
    virtual void SetUp() override {
        credentialstore_ =     
            ::testing::VtsHalHidlTargetTestBase::getService<IIdentityCredentialStore>(CredentialStoreHidlEnvironment::Instance()->getServiceName<IIdentityCredentialStore>());
...
typedef CredentialStoreHidlTest CreateCredentialTest;

TEST_F(CreateCredentialTest, CreateCredential){
